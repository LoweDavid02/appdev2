...
function Btn({ label, onPress, variant = 'primary' }: BtnProps) {
  const bg =
    variant === 'primary'
      ? C.accent
      : variant === 'ghost'
...
function Tag({ label, color = C.accentDim, textColor = C.accent }: TagProps) {
  return (
    ...
    >
      ...
      <View style={styles.heroBlock}>
        ...
        <Text style={styles.heroSub}>
          React Navigation · Native Stack · Expo SDK 54
        </Text>
      </View>
      <Divider />
      {result ? (
  ...
  return (
    ...
    >
      ...
      <View style={styles.heroBlock}>
        ...
        <Text style={[styles.heroTitle, { color: C.teal }]}>
          Detail{'\n'}View
        </Text>
      </View>
      <Divider />
...
const RootStack = createNativeStackNavigator<NestedStackParamList>();
